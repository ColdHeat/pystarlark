...
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // char *
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // unsigned long()(void)
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION, 11), // void()(unsigned long, char *)
...
static char * _cffi_d_Eval(unsigned long x0, char * x1)
{
  return Eval(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_Eval(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "Eval", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_Eval _cffi_d_Eval
#endif

static void _cffi_d_ExecFile(unsigned long x0, char * x1)
{
  ExecFile(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_ExecFile(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "ExecFile", 2, 2, &arg0, &arg1))
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_NewThread(PyObject *self, PyObject *noarg)
{
...
#else
#  define _cffi_f_NewThread _cffi_d_NewThread
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "Eval", (void *)_cffi_f_Eval, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_Eval },
  { "ExecFile", (void *)_cffi_f_ExecFile, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 6), (void *)_cffi_d_ExecFile },
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_starlark(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_starlark(void) { return NULL; }
#  else
     initstarlark(void) { }
#  endif
#  endif
...
{
  return _cffi_init("starlark", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initstarlark(void)
{
  _cffi_init("starlark", 0x2601, &_cffi_type_context);
}
#endif
